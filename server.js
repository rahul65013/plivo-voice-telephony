 ...
 * server.js
 *
 * Plivo outbound call bot — full flow:
 *   1. Call is dialled via POST /make-call
 *   2. Callee picks up → /answer plays greeting + opens bidirectional WS stream
 *   3. /stream WS receives audio → Sarvam STT → transcript
 *   4. ConversationManager decides what audio URL to play back
 *   5. Audio URL is played on the live call via Plivo REST API
